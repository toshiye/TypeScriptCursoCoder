...
const aniversario = new Data(18, 10, 2017)
aniversario.dia = 27
...
const produto1 = new Produto('Caneta BIC', 2.50)
console.log(produto1.resumo())

const produto2 = new Produto('MacBook Ultra Pro', 50000.75)
