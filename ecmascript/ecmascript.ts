...
const turmaA: String[] = ['Sara', 'Heitor', 'Samara']
const turmaB: String[] = ['Gabriel', 'Valdemar', 'Orion', ...turmaA]
...
const numeros = retornarArray(1, 2, 3, 4, 5, 6, 7)
console.log(numeros)
console.log(retornarArray(3, ...numbers))
...
const [ano, motor] =  caracteristicas
console.log(motor)
console.log(ano)
